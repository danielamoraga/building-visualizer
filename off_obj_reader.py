...
if __name__ == "__main__":
    ...
    shapeSuzanne = readOBJ(getAssetPath('holycow.obj'), (0.2, 0, 0))
    gpuSuzanne = createGPUShape(pipeline, shapeSuzanne)

    shapeCarrot = readOBJ(getAssetPath('holycow.obj'), (0.2, 0, 0))
    ...
    glUniform3f(glGetUniformLocation(pipeline.shaderProgram, "lightPosition"), 5, 0, 5)
